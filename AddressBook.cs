...
namespace AdvanceAddressBook
{
    public class Details
    {
        ...
        //we override this tostring method accordin to our requirement in programme.
    }
    class AddressBook
    {
        ...
        //using constructor calling ..
        //we create constructor for our class addressbook 
        // purpose of this constructor making is that due to its constructor we can do preintialisation of methods of it.
        //Selection method
        //our primary method which will do all our work.
        ...
        // what check method will do 
        // basically it will 
        public void Check(Details Obj)
        {
            String Read = File.ReadAllText(@"C:\Users\as\Desktop\.net\AdvanceAddressBookMain\jsconfig1.json");
            if (Read.Length != 0)
            {
                list = JsonConvert.DeserializeObject<List<Details>>(Read);
            }
            list.Add(Obj);
            File.WriteAllText(@"C:\Users\as\Desktop\.net\AdvanceAddressBookMain\jsconfig1.json", JsonConvert.SerializeObject(list));
            Selection();
        }
        //Quit method
        public void Quit()
        ...
        public void Delete()
        {
            ...
            File.WriteAllText(@"C:\Users\as\Desktop\.net\AdvanceAddressBookMain\jsconfig1.json", serialize);
            Display();
        }
        public void Edit()
        {
        ...
        {
            Console.WriteLine("welcome to adddress Book");
            AddressBook sw = new AddressBook();
            sw.Selection();
